package util
{
	...
	public class CollectionChangeManagerTest  
	{
		
		private static var _instance:CollectionChangeManagerTest;
		 ...
		 * 
		 */		
		public static function getInstance():CollectionChangeManagerTest
		{
			if(_instance == null)
				_instance = new CollectionChangeManagerTest();
			return _instance;
		}
		...
		public function setCollection(key:Object,value:Object):void{
			_collectionToChangeItems[key] = value;
		}
		...
		public function tryToAMF(key:Object):ByteArray{
			var ba:ByteArray = new ByteArray();
			var o:Object;
			o = _collectionToChangeItems[key];
			ba.writeObject(o);
			ba.position = 0;
			return ba;
		}
